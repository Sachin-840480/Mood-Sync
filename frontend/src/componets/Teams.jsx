                                    ...
                                    <div role="listitem" className="relative mt-16 mb-32 sm:mb-24">
                                        <div className="rounded overflow-hidden shadow-md bg-white">
                                            ...
                                            <div className="px-6 mt-16">
                                                ...
                                                <p className="text-center text-gray-600 text-base pt-3 font-normal">As the Lead Backend, I designed the Flask-based backend server and managed the MySQL database. I was responsible for integrating the Emotion Detection model and ensuring accurate backend responses.</p>
                                    ...
                                    <div role="listitem" className="relative mt-16 mb-32 sm:mb-24">
                                        <div className="rounded overflow-hidden shadow-md bg-white">
                                            ...
                                            <div className="px-6 mt-16">
                                                ...
                                                <p className="text-gray-800 text-sm text-center">Lead UX Designer</p>
                                                <p className="text-center text-gray-600 text-base pt-3 font-normal">I served as UX Designer and also designed diffrent parts of webpages using react and tailwind and Ensured Homoginity among the Pages.</p>
                                                <div className="w-full flex justify-center pt-5 pb-5">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div role="listitem" className="relative mt-16 mb-32 sm:mb-24">
                                        <div className="rounded overflow-hidden shadow-md bg-white">
                                            ...
                                            <div className="px-6 mt-16">
                                                ...
                                                <p className="text-gray-800 text-sm text-center">Lead UI Designer</p>
